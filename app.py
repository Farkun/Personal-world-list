...
password = 'Sukses123'
cxn_str = f'mongodb+srv://fabimanyu:{password}@atlascluster.pni4lxb.mongodb.net/?retryWrites=true&w=majority'
...
def detail(keyword):
    ...
    if type(definitions[0]) is str:
        ...
        return redirect(url_for(
        'main',
        msg=f'Could not find {keyword}, did you mean one of these words: {suggestions}?'
    ))
